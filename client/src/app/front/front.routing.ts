...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: "topics", component: ForumTopicsComponent, resolve: {topics: AllTopicsResolver}},
      {path: "topics/add", component: AddTopicComponent, resolve: {topics: AllTopicsResolver}},
      {path: "topics/:id", component: SingleTopicComponent, resolve: {topicSelected: GetTopicResolvers, comments: GetCommentsResolvers}},
      {path: "events/:id", component: SingleEventComponent, resolve: {eventSelected: GetEventResolver}},
      {path: "events", component: EventsComponent, resolve: {events: AllEventsResolver}},
    ]
  }
];
